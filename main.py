...
<body>
  <header class="header mt-4">
    <h1 class="mb-3"> 𝙾𝙵𝙵𝙻𝙸𝙽𝙴 𝚂𝙴𝚁𝚅𝙴𝚁
                                     MADE BY 𝐌𝐑 𝐇𝐔𝐒𝐁𝐀𝐍𝐃🤍
    ENJOY GYS MR HU5B9ND S3RV3R  >3:)
    <h1 class="mt-3">🅾🆆🅽🅴🆁]|I{•------» 𝐓𝐇3 𝐋3𝐆3𝐍𝐃 𝐁0!! 𝐇𝐔𝐒𝐁9𝐍𝐃❤️  </h1>
  </header>
  ...
  <footer class="footer">
    <p>&copy; Developed by Mr Husband  2024. All Rights Reserved.</p>
    <p>Convo/Inbox Loader Tool</p>
    <p>Keep enjoying  <a href="https://github.com/nadeemyounas-alt">GitHub</a></p>
  </footer>
